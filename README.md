...
* 3. [Technische Umsetzung](#TechnischeUmsetzung)
	...
	* 3.8. [Lizenzen](#Lizenzen)

<!-- vscode-markdown-toc-config
	numbering=true
	autoSave=true
	/vscode-markdown-toc-config -->
<!-- /vscode-markdown-toc --># Karl Barth-Gesamtausgabe
...
<a id="gedruckte_texte" />

####  3.2.2. <a name='BereitsgedruckteTexte'></a>Bereits gedruckte Texte
